...
public class Main {
    public static void main(String[] args) {
        ...
        @SuppressWarnings("unused") HomePageController homeController = new HomePageController(frame);
        SolveQuestionsPageController solveQuestionsController = new SolveQuestionsPageController(frame);
        @SuppressWarnings("unused") PracticeTestController practiceTestController = new PracticeTestController(frame);
